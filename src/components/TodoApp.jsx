    ...
    <div className="container mt-5">
      ...
      <div className="row mb-3">
        ...
        <div className="col-auto">
          <button onClick={handleAddTodo} className="btn btn-success" style={{border: 'none'}}>Add Todo</button>
        </div>
      </div>
      <div className="row mb-4 justify-content-end">
        <div className="col-auto">
          <div className="form-group">
            <h5>Status Filter:</h5>
            <select className="form-control" value={statusFilter} onChange={handleStatusFilterChange} style={{width: '150px'}}>
          ...
          <div className="col-md-4 mb-4" key={index}>
            <div className="card" style={{backgroundColor: '#12ac89', color: 'white'}}>
              <div className="card-body">
                ...
                <button className="btn btn-primary mr-2" onClick={() => handleEditTodo(index)} style={{backgroundColor: '#007bff', border: 'none'}}>
                  Edit
                </button>
                <button className="btn btn-danger" onClick={() => handleDeleteTodo(index)} style={{backgroundColor: '#dc3545', border: 'none', marginLeft: '15px'}}>
                  Delete
                </button>
              </div>
            </div>
